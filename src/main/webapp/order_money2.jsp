...
int no=0;
try{
	String sql="select a.custno,b.custname,a.salenol,to_char(a.pcost,'999,999,999'),a.amount,a.price,a.pcode,to_char(a.sdate,'YYYY-MM-DD'),c.pname from money1026 a,member1026 b,product1026 c where a.custno=b.custno and a.pcode=c.pcode";
	pstmt=conn.prepareStatement(sql);
	rs=pstmt.executeQuery();
	while(rs.next()){
